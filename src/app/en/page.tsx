...
function Services() {
  return (
    <>
      ...
      >
        <p>
          As a people-centered company, we focus on humans as social beings who need real interaction—something 
          that has been gradually fading in our digital world.
        </p>
      </SectionIntro>
        ...
        <div className="lg:flex lg:items-center lg:justify-end">
          ...
          <List className="mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4">
            <ListItem title="Social Experiences">
              We create opportunities for people to get out more, connecting with others 
              through meaningful social experiences designed for mental well-being.
            </ListItem>
            <ListItem title="Community Building">
              Our platform helps build communities of like-minded people who want to 
              engage in real-world interactions rather than just digital connections.
            </ListItem>
            <ListItem title="Green Initiatives">
              By encouraging people to participate in collective activities, we contribute to 
              a greener and better world through shared experiences and reduction of individual 
      ...
      <Container className="mt-6 sm:mt-8 md:mt-12">
        <FadeIn className="max-w-3xl">
          ...
          <p className="mt-6 text-xl text-neutral-600">
            ...
            have been reduced to just a few clicks.
          </p>
        </FadeIn>
      </Container>
