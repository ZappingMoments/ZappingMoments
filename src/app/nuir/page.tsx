...
import imageForResearch from '@/images/whiteboard.jpg'
import imageForImplementation from '@/images/desenhoazul.png'
import imageForPlanning from '@/images/meeting.jpg'
  ...
  return (
    <div className="relative mt-24 pt-24 sm:mt-32 sm:pt-32 lg:mt-40 lg:pt-40">
      ...
      <Container className="mt-24">
        <GridList>
          <GridListItem title="Digital Mindfulness" className="text-black">
          ...
          <GridListItem title="Community Vitality" className="text-black">
          ...
          <GridListItem title="Authentic Engagement" className="text-black">
          ...
          <GridListItem title="User Autonomy" className="text-black">
          ...
          <GridListItem title="Inclusive Design" className="text-black">
          ...
          <GridListItem title="Ethical Data Use" className="text-black">
