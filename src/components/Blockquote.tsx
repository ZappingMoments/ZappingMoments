...
function BlockquoteWithImage({
  ...
  return (
    ...
    >
      <blockquote className="col-span-2 text-xl/7 text-black sm:col-span-7 sm:col-start-6 sm:row-start-2">
      ...
      <figcaption className="text-sm text-black sm:col-span-7 sm:row-start-3 sm:text-base">
  ...
  return (
    <Border position="left" className={clsx('pl-8', className)}>
      <figure className="text-sm">
        <blockquote className='text-black [&>*]:relative [&>:first-child]:before:absolute [&>:first-child]:before:right-full [&>:first-child]:before:content-["\\""] [&>:last-child]:after:content-["\\""]'>
          {typeof children === 'string' ? <p>{children}</p> : children}
        </blockquote>
